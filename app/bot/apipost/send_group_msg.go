...
func (api ApiPost) Sendgroupmsg(Self_id, Group_id any, Message string, AutoRetract bool) {
...
func (api ApiPost) sendgroupmsg(gss GroupSendStruct) (Message, error) {
