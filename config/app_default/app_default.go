...
const Default_group_help = "这里是群帮助信息：\r\n" +
	...
	"		5.1.简单添加屏蔽词（禁言+撤回）：acfur屏蔽1(+)屏蔽词\r\n" +
	"		5.2.简单添加T出词（禁言+撤回）：acfur屏蔽2(+)屏蔽词\r\n" +
	"		5.3.简单添加撤回（仅撤回）：acfur屏蔽3(+)屏蔽词\r\n" +
	"		5.4.删除屏蔽词/T出词/撤回词：acfur屏蔽-屏蔽词\r\n" +
	"		5.5.高级添加屏蔽词/T出词/撤回词：acfur屏蔽+屏蔽词#处罚，例如acfur屏蔽+触发词#T出撤回\r\n" +
	"		5.6.高级修改屏蔽词/T出词/撤回词：acfur屏蔽=屏蔽词#处罚，例如acfur屏蔽=触发词#屏蔽撤回\r\n" +
