...
const Default_group_help = "这里是群帮助信息：\r\n" +
	...
	"\r\n" +
	"	6.acfur重新验证@某个群员：重新验证某个小黑屋中的群成员，验证成功即刻解禁，验证失败将再次进入小黑屋\r\n" +
	"	7.acfur死亡验证@某个群员：验证某个小黑屋中的群员是否是活人，如果本次验证未通过将会被直接T出\r\n" +
	"acfur测试项目：\r\n" +
	...
	"	4.道具：使用“acfur交易”或道具帮助来查看交易使用方法\r\n"
...
const Default_trade = "交易中心说明：" +
	"\r\n	1.使用“acfur交易”来查看帮助" +
	"\r\n	2.使用“交易中心”来查看可以兑入的币" +
	"\r\n	3.使用“交易购买”/“交易买入”/“交易兑入”[兑换名称][威望]来兑换一个种类，例如“交易兑换官方币”来购买对应币" +
	"\r\n	4.使用“交易卖出”/“交易兑出”/“交易卖掉”[兑换名称][币数量]来用一定数量的币兑换成威望" +
	"\r\n	5.使用“交易我的”来查看你所拥有的全部币种" +
	"\r\n玩法说明：例如有一个币叫A，价格是2比例，你用100威望买入，买入成功后，你就拥有了100威望÷2比例＝50A币，例如过几天A涨到4比例，你选择全部卖出，那么你就拥有50A币×4比例＝200威望"

const Trade_buy = "使用“交易购买”/“交易买入”/“交易兑入”[兑换名称][威望]来兑换一个种类，例如“交易兑换官方币”来购买对应币"
const Trade_sell = "使用“交易卖出”/“交易兑出”/“交易卖掉”[兑换名称][兑换数量]来卖出一个兑换"
const Trade_coin_not_found = "未找到当前币种，或者币种已经不可买入，请换一个，如需查看可交易列表，请输入“交易商店”来查看可交易列表"
